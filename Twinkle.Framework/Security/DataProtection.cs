...
namespace Twinkle.Framework.Security
{
    public class DataProtection
    {
        ...
        //公钥 通过支付宝签名验签工具生成 
        private static readonly string _publicKey = "";
        ...
        /// </summary>
        /// <param name="data">要签名的内容</param>
        /// <param name="privateKey">签名用的私钥</param>
        /// <returns></returns>
        ...
        /// <param name="data">原始数据</param>
        /// <param name="sign">签名后的数据</param>
        /// <param name="publicKey">验证签名用的公钥</param>
        /// <returns></returns>
        ...
        #region 算法实现
        private static System.Security.Cryptography.RSA CreateRsaFromPrivateKey(string privateKey)
        {
        ...
        private static System.Security.Cryptography.RSA CreateRsaFromPublicKey(string publicKeyString)
        {
